...
(define p2 (make-polynomial 'x '((2 0))))

(define p3 (make-polynomial 'x '((2 0) (1 0))))

(define p4 (make-polynomial 'x '((2 0) (1 1))))


(apply-generic '=zero? p1) ; #t
(apply-generic '=zero? p2) ; #t
(apply-generic '=zero? p3) ; #t
(apply-generic '=zero? p4) ; #f
