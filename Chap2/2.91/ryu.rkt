...
; (add poly-2 (make-scheme-number 1))
...
poly-2
; (polynomial x (2 (scheme-number . 6)) (1 (scheme-number . 5)) (0 (scheme-number . 4)))
(sub poly poly-2)
; (polynomial x (2 (scheme-number . -3)) (1 (scheme-number . -3)) (0 (scheme-number . -3)))
...
#|
memo
(5x^3 + 3x^2 + 2x + 1) / (2x^2 + x + 1) で考えてみる
...
除数にかける
(5/2)x * (2x^2 + x + 1) = 5x^3 + (5/2)x^2 + (5/2)x

引く
(5x^3 + 3x^2 + 2x + 1) - (5x^3 + (5/2)x^2 + (5/2)x)
= (1/2)x^2 - 1/2x + 1
...
除数にかける
(1/4) * (2x^2 + x + 1) = (1/2)x^2 + (1/4)x + 1/4

引く
(1/2)x^2 - 1/2x + 1 - ((1/2)x^2 + (1/4)x + 1/4)
= -(3/4)x + (3/4)
...
(> (order t2) (order t1)) -> #t
(list (the-empty-termlist) L1) を返す

----

こんな感じに再帰される

(div-terms (5x^3 + 3x^2 + 2x + 1) (2x^2 + x + 1))
↓
(div-terms ((1/2)x^2 - (1/2)x + 1) (2x^2 + x + 1))
↓
(div-term (-(3/4)x + (3/4)) (2x^2 + x + 1))
↓
(list '() (-(3/4)x + (3/4)))
...
(define dividend 
  (make-polynomial 'x 
                   (list (make-term 3 (make-rational 5 1))   ; 5x^3
                         (make-term 2 (make-rational 3 1))   ; 3x^2
                         (make-term 1 (make-rational 2 1))   ; 2x
                         (make-term 0 (make-rational 1 1))))) ; 1

;; 除数: 2x^2 + x + 1  
(define divisor
  (make-polynomial 'x 
                   (list (make-term 2 (make-rational 2 1))   ; 2x^2
                         (make-term 1 (make-rational 1 1))   ; x
                         (make-term 0 (make-rational 1 1))))) ; 1


(define division-result (div dividend divisor))

(display "商: ")
(car division-result)
; 商: (polynomial polynomial x (1 (rational 5 . 2)) (0 (rational 1 . 4)))
; (5/2)x + 1/4

(display "剰余: ")
(cadr division-result)
; 剰余: (polynomial polynomial x (1 (rational -3 . 4)) (0 (rational 3 . 4)))
; (-3/4)x + 3/4
