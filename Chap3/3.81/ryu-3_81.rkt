...
(display-stream-n random-numbers 10)
; 1 21 48 80 52 32 5 62 1 21 done
...
(define result (random-generator test-requests))

(display-stream-n result 4)

#|
1: 'generate → seed=1  → 21 (rand-update(1))
2: 'generate → seed=21 → 48 (rand-update(21))  
3: '(reset 42) → seed=42 → 出力なし(リセットのみ)
4: 'generate → seed=42 → 63 (rand-update(42))
5: 'generate  → seed=63 → 78 (rand-update(63))
|#
