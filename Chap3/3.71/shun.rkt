...
(define (ramanujan-stream s)
  (let* ((p1 (stream-car s))
         ...
         (w2 (sum-cube-pair p2)))
    (if (= w1 w2)
        (cons-stream (list w1 p1 p2)
                     (ramanujan-stream (stream-cdr (stream-cdr s))))
        (ramanujan-stream (stream-cdr s)))))


(take-stream (ramanujan-stream sum-cubes) 6)
; ((1729 (1 12) (9 10)) (4104 (2 16) (9 15)) (13832 (2 24) (18 20)) (20683 (10 27) (19 24)) (32832 (4 32) (18 30)) (39312 (2 34) (15 33)))
