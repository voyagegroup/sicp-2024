...
application: not a procedure;
 expected a procedure that can be applied to arguments
  given: (procedure (x) ((* x x)) (((false . #f) (true . #t) (car primitive #<procedure:mcar>) (cdr primitive #<procedure:mcdr>) (cons primitive #<procedure:mcons>) (null? primitive #<procedure:null?>) (+ primitive #<procedure:+>) (- primitive #<procedure:...

primitivのmapは以下を超循環評価器に投げている。

(lambda (x) (* x x)) → (procedure (x) (* x x))

自作の評価機は、タグ付けをしているが、primitiveのmapはタグ付けをしない
|#
