...
; https://github.com/voyagegroup/sicp-2024/blob/main/Chap3/3.69/ryu-3_69.rkt
...
(define (a-pythagorean-triple-stream)
  (let ((i (an-integer-starting-from 1))) ; betweenからstarting-fromにおきかえ
...
; 実行がおわらない
; (a-pythagorean-triple-stream)
; i=1, j=1のまま、k=1, 2, 3...と探索が続く


(define (a-pythagorean-triple-stream-2)
  (let ((k (an-integer-starting-from 1))) ; kが長辺
