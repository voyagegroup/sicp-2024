...
variables:(false true car cdr cons null? + - * = < > display)
values:(#f #t (primitive #<procedure:mcar>) (primitive #<procedure:mcdr>) (primitive #<procedure:mcons>) (primitive #<procedure:null?>) (primitive #<procedure:+>) (primitive #<procedure:->) (primitive #<procedure:*>) (primitive #<procedure:=>) (primitive #<procedure:<>) (primitive #<procedure:>>) (primitive #<procedure:mdisplay>))
...
;;; M-Eval input:
(x 'a)
variables:(x false true car cdr cons null? + - * = < > display)
values:#0=((procedure (a) ((display a)) (((x false true car cdr cons null? + - * = < > display) . #0#))) #f #t (primitive #<procedure:mcar>) (primitive #<procedure:mcdr>) (primitive #<procedure:mcons>) (primitive #<procedure:null?>) (primitive #<procedure:+>) (primitive #<procedure:->) (primitive #<procedure:*>) (primitive #<procedure:=>) (primitive #<procedure:<>) (primitive #<procedure:>>) (primitive #<procedure:mdisplay>))
