...
bindings:((x 5) (y 10))
body:((+ x y))
map-car-bindings:(x y)
map-cadr-bindings:(5 10)
...
(define (let->combination exp)
  (let ((bindings (cadr exp))
    ...
    (display 'map-car-bindings:)
    (display (map car bindings)) (newline)
    (display 'map-cadr-bindings:)
    (display (map cadr bindings)) (newline)
