...
; 形容詞
(define adjectives '(adj cute cool kind good))
...
; input
; (parse '(the student studies with a cute cat))

; output
; (sentence (simple-noun-phrase (article the) (noun student)) (verb-phrase (verb studies) (prep-phrase (prep with) (simple-noun-phrase (article a) (adj cute) (noun cat)))))
